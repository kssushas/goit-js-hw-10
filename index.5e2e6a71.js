...
r=tN(r),a.forEach(function(t,n){k.isUndefined(t)||null===t||e.append(!0===s?tL([r],n,i):null===s?r:r+"[]",f(t))}),!1)}}return!!tx(t)||(e.append(tL(o,r,i),f(t)),!1)}let c=[],h=Object.assign(tj,{defaultVisitor:l,convertValue:f,isVisitable:tx});if(!k.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!k.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),k.forEach(r,function(r,i){let s=!(k.isUndefined(r)||null===r)&&o.call(e,r,k.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
...
void 0===o&&i.setContentType(null),"setRequestHeader"in u&&k.forEach(i.toJSON(),function(t,e){u.setRequestHeader(e,t)}),k.isUndefined(t.withCredentials)||(u.withCredentials=!!t.withCredentials),s&&"json"!==s&&(u.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&u.addEventListener("progress",er(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&u.upload&&u.upload.addEventListener("progress",er(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
...
u.send(o||null)})};const ei={http:null,xhr:eo};k.forEach(ei,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
